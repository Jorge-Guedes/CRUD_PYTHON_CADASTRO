...
def inserir():
    ...
    if nome == '':
        ...
        inserir_info(lista)
        message.showinfo('Sucesso', 'Os dados foram inseridos com sucesso')
    ...
    try:
        ...
        def update():
            ...
            if nome == '':
                ...
                message.showinfo('Sucesso', 'Os dados foram atualizados com sucesso')
            ...
            # Botao Atualizar
            b_confirmar = Button(frame_baixo, command=atualizar.update, text='confirmar', width=10, font=('Ivy 9 bold'), bg=co2, fg=co1, relief='raised', overrelief='ridge')
...
# Data de Consulta
l_dia = Label(frame_baixo, text='Data da consulta *', anchor=NW, font=('Ivy 10 bold'), bg=co1, fg=co4, relief='flat')
l_dia.place(x=10, y=190)
e_dia = DateEntry(frame_baixo, width=12, background='darkblue', foreground='white', borderwidth=2, year=2022)
e_dia.place(x=15, y=220)

# Estado
l_estado = Label(frame_baixo, text='Estado da consulta *', anchor=NW, font=('Ivy 10 bold'), bg=co1, fg=co4, relief='flat')
l_estado.place(x=155, y=190)
